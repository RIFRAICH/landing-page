      ...
      <section className={styles.footerSections}>
        <section className={styles.newsletterSection}>
          ...
          <p className={styles.newsletterDescription}>
            Tu adores chiner des trésors cachés ? Notre newsletter est faite
            pour toi ! On te dévoile nos coups de cœur, les nouveaux arrivages
            et des actualités friperie
          </p>
          <form
          ...
          <section className={styles.newsletterSocials}>
            <Link to={SOCIAL_INSTAGRAM_URL} target="_blank">
              <InstagramIcon />
            </Link>
            <Link to={SOCIAL_FACEBOOK_URL} target="_blank">
              <FacebookIcon />
            </Link>
            <Link to={SOCIAL_PINTEREST_URL} target="_blank">
              <PinterestIcon />
            </Link>
            <Link to={SOCIAL_TIKTOK_URL} target="_blank">
              <TiktokIcon />
            </Link>
          </section>
        </section>
        <section>
          ...
          <section className={styles.footerSectionLinks}>
            ...
            <Link
              className={styles.footerLink}
              onClick={() => handleLinkClick("#commitment")}
            >
              Engagements
            </Link>
            <Link className={styles.footerLink} to={BLOG_URL} target="_blank">
              Le Blog RIFRAICH
            </Link>
          </section>
        </section>
        <section>
          ...
          <section className={styles.footerSectionLinks}>
            <Link className={styles.footerLink} to={STATUS_URL} target="_blank">
              État des services
            </Link>
            <Link
              className={styles.footerLink}
