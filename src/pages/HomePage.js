...
import {ArrowUpRightIcon, ChartIcon, PackageIcon, PlugsIcon} from "../utils/Icons";
        ...
        <>
            ...
            <section id="commitment" className={styles.commitmentContainer}>
                ...
                <section className={styles.commitmentCards}>
                    ...
                    <CommitmentCard title="Une nouvelle expérience pour la seconde main" description="Nous sommes convaincus que la mode seconde main mérite une expérience d'achat à la hauteur de vos attentes. C'est pourquoi nous nous engageons à offrir à nos clients une sélection rigoureuse de pièces, un emballage soigné et un service client personnalisé." img={womanStrawberryImg} reverse />
                    <CommitmentCard title="Ensemble, faisons rayonner la mode seconde main" description="Nous sommes convaincus que l'union fait la force. En regroupant les friperies angevines sur une seule plateforme, nous créons un écosystème dynamique où chacun peut bénéficier de l'expertise des autres." img={manWomanJacketJeansImg} />
                </section>
            </section>
            <section className={styles.ctaShopContainer}>
                <p className={styles.ctaShopTitle}>Prêt à révolutionner votre manière de vendre des vêtements d'occasion ?</p>
                <section className={styles.ctaShopContent}>
                    <p className={styles.ctaShopDescription}>Rejoignez une communauté de fripiers passionnés et dynamiques.</p>
                    <section className={styles.ctaShopButtons}>
                        <RoundedButton buttonColor="#262D6A" textColor="#FFF" text="Lancez-vous" className={styles.ctaShopGoButton} />
                        <RoundedButton buttonColor="transparent" textColor="#262D6A" text="En savoir plus" className={styles.ctaShopSeeMoreButton} icon={<ArrowUpRightIcon />} />
                    </section>
                </section>
            </section>
            <section id="contact" className={styles.contactContainer}>
                ...
                <form className={styles.contactForm} onSubmit={handleContactForm}>
                    ...
                    <section className={styles.contactSection}>
                        <InputLabel className={styles.contactInput} id="email" type="email" placeholder="Email" required />
